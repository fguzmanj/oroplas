...
function Conditions() {
    return (
        ...
        <div className="conteiner d-flex justify-content-center">
            ...
            <p></p>
            <p>
                El presente Política de Privacidad establece los términos en que OROPLAS usa y 
                protege la información que es proporcionada por sus usuarios al momento de utilizar su sitio 
                web. Esta compañía está comprometida con la seguridad de los datos de sus usuarios. Cuando 
                ...
                que le recomendamos y enfatizamos revisar continuamente esta página para asegurarse que 
            ...
            <p></p>
            <p>
                OROPLAS está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los sistemas más avanzados y los actualizamos constantemente para asegurarnos que no exista ningún acceso no autorizado.
            </p>
            ...
            <p className="text-center">
                OROPLAS Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.
            </p>
